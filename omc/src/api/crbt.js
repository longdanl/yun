...
//文件排序
export function sortByFile(type,data) {
    return request({
        url:'/api/crbt/10086/files?sort='+type+' '+data,
        method: 'get',
    })
}
//号码排序
export function sortByPhone(type,data) {
    return request({
        url:'/api/crbt/10086/numberbindings?sort='+type+' '+data,
        method: 'get',
    })
}
